<template>
    <div>
         <el-dialog :visible.sync="dialogVisible" :before-close="handleClose" title="插座" :close-on-click-modal="false">
            <el-container>
                <div>
                    <div class="modelK">
                    ...
                    <div>
                        <el-row class="htp">
                            ...
                            <el-col :span="10">酒店 > 一栋 > 一单元 > 一楼 > 101室</el-col>
                        </el-row>
                        <el-row class="htp">
                            <el-col :span="4" :offset="4">设备类型：</el-col>
                            <el-col :span="10">sos面板</el-col>
                        </el-row>
                        <el-row class="htp">
                            <el-col :span="4" :offset="4">设备MAC：</el-col>
                            <el-col :span="10">10.20.30.40</el-col>
                        </el-row>
                        <el-row class="htp">
                    ...
                    <div>
                        <el-row class="htp">
                            ...
                            <el-col :span="10">
                                <el-switch v-model="value1" active-text="" inactive-text=""></el-switch>
                            </el-col>
                        </el-row>
                    </div>
                    <div class="modelK">
                        <p class="modelTit">参数设定</p>
                    </div>
                    <el-row class="htp" type="flex" align="middle">
                        <el-col :span="4" :offset="4">
                            <el-row>
                                <el-col :span="9">断电记忆：</el-col>
                                <el-col :span="9">
                                    <el-switch v-model="value1" active-text="" inactive-text=""></el-switch>
                                </el-col>
                            </el-row>
